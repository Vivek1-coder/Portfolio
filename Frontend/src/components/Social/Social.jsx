...
const Social = () => {
  return (
    <div className='flex gap-10 bg-white w-full md:w-96  h-auto text-black justify-between items-center px-10 py-2 md:py-4 rounded-2xl   '>
     
      <a href="https://linkedin.com/in/vivek1-coder/"><Linkedin className='z-40  h-5 w-12 md:h-12 text-blue-700 fill-blue-700 hover:fill-blue-800 hover:text-blue-800 hover:scale-105 ' src={linkedIn} alt="" /></a>
